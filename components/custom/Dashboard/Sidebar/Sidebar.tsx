    ...
    return (
      <Link target={target} className={"w-full"} href={href} passHref>
        <Button
          ...
          variant={"ghost"}
          className={cn(
            "w-full gap-2 justify-start transition-all group-data-[state=open]/sidebar:justify-start ",
            "[&_svg]:size-4",
        ...
        >
          ...
          {path === href && (
            <span className="text-blue-500 text-lg no-underline">&#8226;</span>
          )}
        </Button>
      </Link>
    );
