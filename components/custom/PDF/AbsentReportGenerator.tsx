...
import { getAllAbsentReports } from "@/app/(server)/actions/getAllAbsentReports";

export default function AbsentReportGenerator({
  company,
  filters,
}: {
  company: ICompany;
  ...
  const handleClick = useCallback(async () => {
    ...
    const reports = await getAllAbsentReports({
