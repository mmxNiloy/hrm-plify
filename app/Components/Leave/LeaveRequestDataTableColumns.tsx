...
export const LeaveRequestDataTableColumns: ColumnDef<ILeaveRequestWithCurrentEmployee>[] =
  [
    {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <SortableHeader column={column} name="End Date" />
      ),
      cell: ({ row }) =>
    ...
    },
    {
      ...
      cell: ({ row }) =>
        ...
        row.original.currentEmployee.leave_approvers?.is_active == 1 ? (
