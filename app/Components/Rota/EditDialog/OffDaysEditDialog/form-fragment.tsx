    ...
    <>
      ...
      <div className="flex gap-2">
        <Checkbox
          ...
          name="sunday"
          disabled={disabled || readOnly}
          defaultChecked={data?.sunday == 1 ? true : false ?? false}
        />
      ...
      <div className="flex gap-2">
        <Checkbox
          ...
          name="monday"
          disabled={disabled || readOnly}
          defaultChecked={data?.monday == 1 ? true : false ?? false}
        />
      ...
      <div className="flex gap-2">
        <Checkbox
          ...
          name="tuesday"
          disabled={disabled || readOnly}
          defaultChecked={data?.tuesday == 1 ? true : false ?? false}
        />
      ...
      <div className="flex gap-2">
        <Checkbox
          ...
          name="wednesday"
          disabled={disabled || readOnly}
          defaultChecked={data?.wednesday == 1 ? true : false ?? false}
        />
      ...
      <div className="flex gap-2">
        <Checkbox
          ...
          name="thursday"
          disabled={disabled || readOnly}
          defaultChecked={data?.thursday == 1 ? true : false ?? false}
        />
      ...
      <div className="flex gap-2">
        <Checkbox
          ...
          name="friday"
          disabled={disabled || readOnly}
          defaultChecked={data?.friday == 1 ? true : false ?? false}
        />
      ...
      <div className="flex gap-2">
        <Checkbox
          ...
          name="saturday"
          disabled={disabled || readOnly}
          defaultChecked={data?.saturday == 1 ? true : false ?? false}
        />
