...
import TaskSearch from "@/app/Components/Dashboard/Task/TaskSearch";
import TasksTable from "@/app/Components/Dashboard/Task/TasksTable";
...
export default async function CompanyTasksDashboardPage({
  ...
  return (
    <main className="container flex flex-col gap-2">
      ...
      <TasksTable company_id={params.companyId} />
    </main>
  );
}
