...
import { UserAccessPageCompanyDataTableColumns } from "@/app/Components/UserAccess/UserAccessPageCompanyDataTableColumns";
...
export default async function UserAccessPage({
  ...
  return (
    <main className="container flex flex-col gap-2">
      ...
      <div className="flex items-center justify-between">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>User Access Management</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
      ...
      <StaticDataTable
        data={companies}
        columns={UserAccessPageCompanyDataTableColumns}
